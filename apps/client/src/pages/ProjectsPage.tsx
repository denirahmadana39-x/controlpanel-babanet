    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">Sites you manage</p>
        </div>
        ...
        <CardBody className="p-0">
          {query.isLoading ? (
            ...
            <EmptyState
              ...
              description="Create your first project to start hosting a static site."
            />
          ) : (
                    ...
                    <div className="flex items-center justify-between">
                      <div className="min-w-0">
                        <div className="flex items-center gap-2">
                          <p className="truncate font-medium text-slate-200">{project.name}</p>
